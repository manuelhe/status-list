 ...
 *
 * Result could be customized extending the .radial-graph class.
 *
 * How to use:
 *
 *   <div radial-graph
 ...
 *
 */
angular.module('statuslist').directive('radialGraph', function radialGraph() {
  'use strict';
  ...
  return {
    ...
    replace: false,
    restrict: 'A',
    templateUrl: 'app/components/radial_graph/radial_graph.html',
    scope: {
      value: '=',
      size: '@',
